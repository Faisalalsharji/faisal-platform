...
USD_TO_SAR = 3.75
HALAL_STOCKS = ["AAPL", "MSFT", "TSLA", "NVDA", "GOOG", "AMZN", "META"]
...
def evaluate_stock(symbol):
    try:
        ...
        percent = ((price - prev) / prev) * 100 if prev else 0
...
# واجهة المستخدم
st.set_page_config(page_title="الأسهم الحلال الذكية", layout="wide")
...
for symbol in matches:
    ...
    if result:
        ...
        st.warning(f"{symbol}: تعذر عرض بيانات.")
